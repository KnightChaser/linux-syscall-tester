...
static const syscall_entry table[] = {
    ...
    {"fcntl", invoke_fcntl_syscall},       {"link", invoke_link_syscall},
    {"linkat", invoke_linkat_syscall},     {"mkdir", invoke_mkdir_syscall},
    ...
    {"rmdir", invoke_rmdir_syscall},       {"unlink", invoke_unlink_syscall},
    {"unlinkat", invoke_unlinkat_syscall}, {"write", invoke_write_syscall},
