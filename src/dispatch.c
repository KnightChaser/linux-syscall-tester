...
static const syscall_entry table[] = {{"close", invoke_close_syscall},
                                      ...
                                      {"link", invoke_link_syscall},
                                      {"linkat", invoke_linkat_syscall},
                                      ...
                                      {"rmdir", invoke_rmdir_syscall},
                                      {"symlink", invoke_symlink_syscall},
                                      {"symlinkat", invoke_symlinkat_syscall},
                                      {"unlink", invoke_unlink_syscall},
                                      {"unlinkat", invoke_unlinkat_syscall},
