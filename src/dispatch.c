...
static const syscall_entry table[] = {
    ...
    {"open", invoke_open_syscall},       {"pread64", invoke_pread64_syscall},
    {"preadv", invoke_preadv_syscall},   {"pwrite64", invoke_pwrite64_syscall},
    {"pwritev", invoke_pwritev_syscall}, {"read", invoke_read_syscall},
    {"readv", invoke_readv_syscall},     {"write", invoke_write_syscall},
